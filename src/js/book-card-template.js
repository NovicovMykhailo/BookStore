export function createBookCard(book, delay) {
  ...
  return `<li class="book-card" data-aos="flip-left" data-aos-delay="${delay}" data-aos-anchor-placement="top-bottom" data-aos-once="true">
    <a href="#" class="book-card__link" title="${title}">
