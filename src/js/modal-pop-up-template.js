export function createModalPopUpCard(book) {
  const { _id, list_name, author, book_image, description, buy_links: [ { name, url } ] } = book;
  return `<div class="modal__pop-up">
    ...
    <div class="pop-up__book">
      <div class="pop-up__book-container">
        ...
        <div>
          ...
          <ul class="book__list">
            <li class="book__item">
              <a class="book__buy-links" href="" target="_blank" rel="noopener noreferrer" aria-label="Amazon">
            ...
            <li class="book__item">
              <a class="book__buy-links" href="" target="_blank" rel="noopener noreferrer" aria-label="Apple Books">
                <picture class="buy-links__icon">
                  <source
            ...
            <li class="book__item">
              <a class="book__buy-links" href="" target="_blank" rel="noopener noreferrer" aria-label="Bookshop">
                <picture class="buy-links__icon">
                  <source
